...
class StatisticsAnalyzer:
    ...
    def __init__(self):
        ...
        self._logger.info("통계 분석기 객체 생성")
        self.total_spent = 0
        self.total_won = 0
